...
class SimplyGreenTrade:
        ...
        for catalog in tqdm(self.catalog_urls):
            ...
            if product_count:
                ...
                try:
                    ...
                    logging.info('Unable to find page counter : parse_simply.py:92, Exception)')
            elif 'new' in catalog:
    ...
    def _parse_details(self, url: str, category: str) -> dict:
        """
        ...
        if soup.find('h1', class_='product_title') is None:
            return
